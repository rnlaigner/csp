...
*/
    ...
    */
    ...
    // save time spent in file
//    char filename[1000];
    char filename[100];
    sprintf(filename, "%d_%d.txt", NUM_THREADS, HASH_BITS);  

/*
    printf("num threads in str is %s\n",num_threads_str);

    strcpy(filename, num_threads_str);
    strcpy(filename, "_");
    //strcpy(filename, sprintf (HASH_BITS));
    strcpy(filename, ".txt");
*/
    printf("name of file is %s",filename);
